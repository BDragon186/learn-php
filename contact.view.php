                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/" aria-current="page" class="text-gray-300 hover:bg-white/5 hover:text-white rounded-md text-gray-300 hover:bg-white/5 hover:text-white px-3 py-2 text-sm font-medium text-white">Home</a>
